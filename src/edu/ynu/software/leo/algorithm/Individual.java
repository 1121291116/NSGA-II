...
public class Individual {
	...
	//Derived attributes
	public List<Double> adaptiveValues = new ArrayList<>();		// 适应度值
	public List<Integer> clusterSizes = new ArrayList<>();		// 聚类规模数
	...
	public void calcClusterSizes(){
		Integer count;
		Integer index;
		for (int i = 0; i < clusterCount; i++) {		// 根据设置的聚类数，初始化聚类规模
